...
<x-sendportal.text-field name="text1" :label="__('Text1')" :value="$subscriber->text1 ?? null" />
<x-sendportal.text-field name="text2" :label="__('Text2')" :value="$subscriber->text2 ?? null" />
